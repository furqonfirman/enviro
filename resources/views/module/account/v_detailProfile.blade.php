            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Contract</a></li>
                  <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">Scedule</a></li>
                  <li class="nav-item"><a class="nav-link" href="#settings" data-toggle="tab">Forgot Password</a></li>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
